    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ trans('Dashboard/receipt.delete_bond') }}</h5>
            ...
            <div class="modal-body">
                ...
                <h5>{{trans('Dashboard/sections_trans.text')}}<span style="color: red"> {{ $receipt->patients->name }}</span></h5>
            </div>
