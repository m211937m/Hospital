...
@section('title')
    {{ trans('Dashboard/ray_emp.invoices_completed') }}
@stop
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Dashboard/ray_emp.invoices_completed') }}</h4>
                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td><a href="{{ route('view_ray_employee',$invoice->id) }}">{{ $invoice->Patient->name }}</a></td>
                                    ...
                                    <td>
                                        <a class="btn ripple btn-outline-primary btn-sm" href="{{route('invoices_ray_employee.edit',$invoice->id)}}"><i class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;{{ trans('Dashboard/Statements_trans.Add_Diagnosis') }}</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
