...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{trans('Dashboard/main-sidebar-trans.service')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/main-sidebar-trans.insurance_companies')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('insurance.update','test')}}" method="post">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea rows="5" cols="10" class="form-control"
                                          name="notes">{{$insurances->note}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <button class="btn btn-success lg">{{trans('Dashboard/sections_trans.ubdate')}}</button>
                            </div>
                        </div>
                    </form>
                </div>
