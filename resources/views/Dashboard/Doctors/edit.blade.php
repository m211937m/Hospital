...
@section('title')
    {{trans('Dashboard/doctor_trans.update')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{trans('Dashboard/doctor_trans.doctor ')}}</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/
               {{trans('Dashboard/doctor_trans.update')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <form action="{{ route('Doctors.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            <div>
                                @if($doctor->image)
                                    <img style="border-radius:20%"
                                         src="{{Url::asset('Dashboard/img/doctor/'.$doctor->image->filename)}}"
                                         height="150px" width="150px" alt="">
                                @else
                                    <img style="border-radius:50%"
                                         src="{{Url::asset('Dashboard/img/doctor/default.jpg')}}"
                                         height="50px"
                                         width="50px" alt="">
                                @endif
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{trans('Dashboard/doctor_trans.name')}}</label>
                                </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{trans('Dashboard/doctor_trans.email')}}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{ trans('Dashboard/doctor_trans.phone') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{trans('Dashboard/doctor_trans.section_name')}}</label>
                                </div>
                            ...
                            <div class=" row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{trans('Dashboard/doctor_trans.appointments')}}</label>
                                </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                    <label for="exampleInputEmail1">
                                        {{ trans('Dashboard/doctor_trans.image') }}</label>
                                </div>
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                            ...
                            <button type="submit"
                                    class="btn btn-main-primary pd-x-30 mg-r-5 mg-t-5">{{ trans('Dashboard/doctor_trans.update') }}</button>
                        </div>
                    </form>
                </div>
            </div>
