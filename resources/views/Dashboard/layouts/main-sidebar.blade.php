				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="">{{trans('Dashboard/main-sidebar-trans.group_services')}}</a></li>
							<li><a class="slide-item" href="">{{trans('Dashboard/main-sidebar-trans.insurance_companies')}}</a></li>
							<li><a class="slide-item" href="">{{trans('Dashboard/main-sidebar-trans.ambulance')}}</a></li>
