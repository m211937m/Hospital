    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('invoices_ray_employee.index') }}">{{ trans('Dashboard/main-sidebar-trans.List_of_Statements') }}</a></li>
                    <li><a class="slide-item" href="{{ route('complete_invoices_ray_employee') }}">{{ trans('Dashboard/main-sidebar-trans.List_of_completed_statements') }}</a></li>
                </ul>
            </li>
        </ul>
    </div>
