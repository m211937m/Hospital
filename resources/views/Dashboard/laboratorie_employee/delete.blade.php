    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ trans('Dashboard/employee.Dlete_Employees_information') }}</h5>
            ...
            <div class="modal-body">
                <h5>{{trans('Dashboard/sections_trans.text')}} {{$laboratorie_employee->name}}</h5>
            </div>
